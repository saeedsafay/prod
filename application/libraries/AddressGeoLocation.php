...
class AddressGeoLocation {
    ...
    protected function doCall ( $parameters = array() ) {
        ...
        if ( !function_exists('curl_init') ) {
            // throw error
            throw new AddressGeoLocationException('This method requires cURL (http://php.net/curl), it seems like the extension isn\'t installed.');
        }
        // define url
        ...
        // we have errors
        if ( $errorNumber != '' )
            throw new AddressGeoLocationException($errorMessage);
    ...
    $street = null , $streetNumber = null , $city = null , $zip = null , $country = null
    ) {
        // init item
        $item = array();
        // add street
...
/**
 * AddressGeoLocation Exception
 *
 * @author Jeroen Desloovere <info@jeroendesloovere.be>
 */
class AddressGeoLocationException extends \Exception {
