            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        <h1>کاربر گرامی، <?php echo $user['first_name'] ?></h1>
                                        <?php echo $content; ?>
              ...
              <strong>Due By:</strong> {{due_date}}
                                 ...
                                 https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                    ...
                                                    <table class="purchase_content" width="100%" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td width="80%" class="purchase_item"><span
                                                                        class="f-fallback">{{description}}</span></td>
                                                            <td class="align-right" width="20%" class="purchase_item">
                                                                <span class="f-fallback">{{amount}}</span></td>
                                                        </tr>
                                                        {{/each}}
                                                        <tr>
                                        ...
                                        <p>If you have any questions about this invoice, simply reply to this email or
