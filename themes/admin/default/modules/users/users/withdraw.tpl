                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {else if $val->status eq 3}
                                    <label class="uk-text-primary">رد شده</label>
                                {/if}
                            </td>
                            ...
                            <td>
                                ...
                                {if $val->status != 1}
                                    <a href="{site_url({ADMIN_PATH|con:'/users/users/cancel-withdraw/':$val.id})}" class="md-btn md-btn-small md-btn-danger">لغو و برگشت وجه</a>
                                {/if}
                            </td>
                        </tr>
                    {/foreach}
