                                        ...
                                        <div class="uk-width-medium-1-2 uk-float-right uk-margin-top">
                                            <div class="uk-width-medium-5-6 uk-margin-large-bottom">
                                                <div class="uk-form-row">
                                                    <label class="uk-form-label" for="business_name">نام مجموعه</label>
                                                    <input type="text" id="business_name"
                                                           class="md-input{if  (NULL != form_error('business_name'))}{' md-input-danger '}{/if}"
                                                           name="business_name"
                                                           value="{set_value('business_name', (isset($User->business_name)) ? $User->business_name : '')}">
                                                </div>
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-large-bottom">
                                                <div class="uk-form-row">
                                                    ...
                                                    <input type="text" maxlength="60" id="first_name"
                                                           class="md-input{if  (NULL != form_error('first_name'))}{' md-input-danger '}{/if}"
                                                           name="first_name"
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-large-bottom">
                                                <div class="uk-form-row">
                                                    ...
                                                    <input type="text" maxlength="60" id="last_name"
                                                           class="md-input{if  (NULL != form_error('last_name'))}{' md-input-danger '}{/if}"
                                                           name="last_name"
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-large-bottom">
                                                <div class="uk-form-row">
                                                    ...
                                                    <input type="text" maxlength="60" id="username"
                                                           class="md-input{if  (NULL != form_error('username'))}{' md-input-danger '}{/if}"
                                                           name="username"
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-large-bottom">
                                                <div class="uk-form-row">
                                                    <label class="uk-form-label" for="sale_percent">درصد سود فروش برای
                                                        سایت(برای فروشندگان و عددی بین 0 تا 100)</label>
                                                    <input type="text" maxlength="3" id="sale_percent"
                                                           class="md-input{if  (NULL != form_error('sale_percent'))}{' md-input-danger '}{/if}"
                                                           name="sale_percent"
                                                           value="{set_value('sale_percent', (isset($User->sale_percent)) ? $User->sale_percent : '')}">
                                                </div>
                                                <span class="error_page_content">
                                                    {form_error('sale_percent')}  
                                                </span>
                                            </div>
                                            <div class="uk-width-medium-5-6 uk-margin-large-bottom">
                                                <div class="uk-form-row">
                                                    ...
                                                    <span class="icheck-inline">
                                                        <input type="radio" id="status0" name="status" value="0"
                                                               data-md-icheck {if (isset($is_activated) AND $is_activated== false )}{'checked'}{/if}>
                                                        <label for="status0" class="inline-label">غیرفعال</label>
                                                    </span>
                                                    <span class="icheck-inline">
                                                        <input type="radio" id="status1" name="status" value="1"
                                                               data-md-icheck {if (isset($is_activated) AND $is_activated== true )}{'checked'}{/if}>
                                        ...
                                        <div class="uk-width-medium-1-2 uk-float-left uk-margin-top">
                                                ...
                                                <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                    <div class="uk-form-row">
                                                        <div class="uk-width-medium-2-5">
                                                            <label class="uk-form-label" for="roles"> گروه
                                                                کاربری</label>
                                                            {foreach from=$Roles item=role}
                                                                <p>
                                                                    <input type="checkbox" name="role_id[]"
                                                                           id="role_id{$role.id}" value="{$role->id}"
                                                                           data-md-icheck {if isset($User) and ($User->getRoles()->contains($role.id))}{'checked'}{/if} />
                                                                    <label for="role_id{$role.id}"
                                                                           class="inline-label">{$role->name}</label>
                                                                </p>
                                                            {/foreach}
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                <div class="uk-form-row">
                                                    ...
                                                    <input type="text" maxlength="60" id="email" class=" md-input"
                                                           name="email"
                                            ...
                                            <div class="uk-width-medium-5-6 uk-margin-small-top">
                                                <div class="uk-form-row">
                                                    ...
                                                    <input type="text" maxlength="60" id="mobile" class=" md-input"
                                                           name="mobile"
                                                           value="{set_value('mobile', (isset($User->mobile)) ? $User->mobile : '')}">
                                                </div>
                                                <span class="error_page_content">
                                                    {form_error('mobile')}  
                                                </span>
                                            ...
                                            {if (!$edit_mode)}
                                                <div class="uk-width-medium-5-6 uk-margin-small-bottom">
                                                    <div class="uk-form-row">
                                                        ...
                                                        <input type="password" maxlength="60" id="password"
                                                               class="input-count md-input" name="password">
                                                    </div>
                                                    <span class="error_page_content">
                                                        {form_error('password')}  
                                                    </span>
                                                ...
                                                <div class="uk-width-medium-5-6 ">
                                                    <div class="uk-form-row">
                                                        ...
                                                        <input type="password" maxlength="60" id="confirm_password"
                                                               class=" md-input" name="confirm_password">
                                                    </div>
                                                    <span class="error_page_content">
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <div class="uk-form-row">
                                                    <div class="uk-margin-top">
                                                        ...
                                                        <input type="password" maxlength="60" id="confirm_password"
                                                               class="input-count md-input" name="confirm_password">
                                                        <div id="input_counter_counter" class="text-count-wrapper">
                                                        </div>
                                                        <span class="md-input-bar"></span>
                                                    </div>
                                                        ...
                                                        {foreach $perms as $singlePermission}
                                                            <p>
                                                                <input type="checkbox" name="user_permissions[]"
                                                                       value="{$singlePermission.permission}" {if isset($User) and ($User->hasAccess([$singlePermission.permission]) OR $User->getRoles()->contains(1))}{'checked'}{/if}
                                                                       id="user-{$i}" data-md-icheck/>
                                                                <label for="user-{$i}"
                                                                       class="inline-label">{$singlePermission.label}</label>
                                                            </p>
