    ...
    <div class="md-card  uk-margin-small-top">
        <div class="md-card-content">
            <div class="uk-width-medium-1-6 uk-margin-small-bottom">
                <a class="md-btn md-btn-success" href="{site_url({ADMIN_PATH|con:"/shop/colors/edit"})}">افزودن رنگ</a>
            </div>
        </div>
    </div>
                ...
                <tbody class="uk-table uk-table-striped">
                    {foreach from=$Colors item=val}
                        <tr>
                            ...
                            <td class="right">
                                <a class="md-btn md-btn-primary md-btn-small" href="{site_url({ADMIN_PATH|con:'/shop/colors/edit/' : $val->id})}">ویرایش</a>
                                <a href="{site_url({ADMIN_PATH|con:'/shop/colors/delete/':$val->id})}" class="md-btn md-btn-small md-btn-danger delete" id="delete-btn">حذف رنگ</a>
                            </td>
                        </tr>
                    {/foreach}
                </tbody>
