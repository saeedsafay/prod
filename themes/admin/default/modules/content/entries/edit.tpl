                ...
                <form method="POST" action="" id="form_validation" class="uk-form-stacked" enctype="multipart/form-data">
                    <div data-uk-grid-margin="" class="uk-grid">
                        <div class="uk-width-medium-1-2">
                            ...
                            {/if}
                            <div class="uk-margin-top">
                                <h3 class="heading_c">مرتبط با دسته بندی محصول</h3>
                                <div class="uk-width-medium-1-1" data-uk-grid-margin="">
                                    <select class="data-md-closable-selectize" data-md-selectize-bottom="" name="product_categories[]" multiple>
                                        <option value="">انتخاب دسته بندی</option>
                                        {foreach $Product_categories as $category}
                                            <option value="{$category.id}"{if isset($Entry) && $Entry->product_categories->contains($category.id) } selected{/if}>{$category.title}</option>
                                        {/foreach}
                                    </select>         
                                </div>
                            </div>
                            <span class="error_page_content">
                                {form_error('product_categories[]')}  
                            </span>
                        </div>
                        <div class="uk-width-medium-1-2">
                            <div class="uk-margin-top">
