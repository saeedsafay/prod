            ...
            <div class="uk-overflow-container">
                <div class="uk-width-medium-1-1 uk-margin-top">
                    <p class="text-danger uk-text-italic">
                        ارسال کننده: {$Contact.user.first_name} {$Contact.user.last_name}
                    </p>
                    <p class="text-success uk-text-italic">
                        گیرنده: {$Contact.r_user.first_name} {$Contact.r_user.last_name}
                    </p>
                    <p>{$Contact.content}</p>
                ...
                <div class="uk-width-1-1 ">
                    <form method="POST" action="{$action}" id="form_validation" class="uk-form-stacked" enctype="multipart/form-data">
                            ...
                            <div class="uk-width-medium-2-3">
                                <div class="uk-form-row">
                                    <div class="uk-margin-top">
                                        ...
                                        <input type="text" maxlength="150" id="input_counter" class="{if  (NULL != form_error('subject'))}{' md-input-danger '}{/if}input-count md-input title" name="subject" value="{'پاسخ::'|con:$Contact.subject:':'}" >
                        ...
                        <div class="uk-width-medium-1-4">
                            <input type="hidden" name="to" value="{$Contact.from}"/>
