...
<main class="site-main js-get-pages-id" id="js-product-detail">
                ...
                <div class="col-md-4 col-sm-12 padding-right">
                    <div class="product-media">
                        ...
                        <div class="product-preview image-small product_preview">
                            {literal}<div id="thumbnails" class="thumbnails_carousel owl-carousel nav-style4" data-nav="true" data-autoplay="false" data-dots="false" data-loop="true" data-margin="10" data-responsive='{"0":{"items":3},"480":{"items":5},"600":{"items":5},"1000":{"items":5}}'>{/literal}
                                <a href="#" data-image="images/detail/thick-box-1.jpg" data-zoom-image="images/detail/thick-box-1.jpg">
                                    <img src="{assets_url}images/detail/i1.jpg" data-large-image="images/detail/thick-box-1.jpg" alt="i1">
                                </a>
                                <a href="#" data-image="images/detail/thick-box-1.jpg" data-zoom-image="images/detail/thick-box-1.jpg">
                                    <img src="{assets_url}images/detail/i2.jpg" data-large-image="images/detail/thick-box-1.jpg" alt="i1">
                                </a>
                                <a href="#" data-image="images/detail/thick-box-1.jpg" data-zoom-image="images/detail/thick-box-1.jpg">
                                    <img src="{assets_url}images/detail/i2.jpg" data-large-image="images/detail/thick-box-1.jpg" alt="i1">
                                </a>
                ...
                <div class="col-md-5 col-sm-6">
                    <div class="product-info-main">
                        ...
                        <div class="group-btn-share">
                            <a href="#"><img src="{assets_url}images/detail/btn1.png" alt="btn1"></a>
                            <a href="#"><img src="{assets_url}images/detail/btn2.png" alt="btn1"></a>
                            <a href="#"><img src="{assets_url}images/detail/btn3.png" alt="btn1"></a>
                            <a href="#"><img src="{assets_url}images/detail/btn4.png" alt="btn1"></a>
                        </div>
    ...
    <div class="block-recent-view">
        <div class="container">
            ...
            {literal}<div class="owl-carousel nav-style2 border-background equal-container" data-nav="true" data-autoplay="false" data-dots="false" data-loop="true" data-margin="0" data-responsive='{"0":{"items":1},"480":{"items":2},"600":{"items":3},"1000":{"items":6}}'>{/literal}
                ...
                <div class="product-item style1">
                    <div class="product-inner equal-elem">
                        <div class="product-thumb">
                            <div class="thumb-inner">
                                <a href=""><img src="{assets_url}images/home1/r3.jpg" alt="r3"></a>
                            </div>
                ...
                <div class="product-item style1">
                    <div class="product-inner equal-elem">
                        <div class="product-thumb">
                            <div class="thumb-inner">
                                <a href=""><img src="{assets_url}images/home1/r4.jpg" alt="r4"></a>
                            </div>
                ...
                <div class="product-item style1">
                    <div class="product-inner equal-elem">
                        <div class="product-thumb">
                            <div class="thumb-inner">
                                <a href=""><img src="{assets_url}images/home1/r5.jpg" alt="r5"></a>
                            </div>
                            <span class="onsale">-50%</span>
                ...
                <div class="product-item style1">
                    <div class="product-inner equal-elem">
                        <div class="product-thumb">
                            <div class="thumb-inner">
                                <a href=""><img src="{assets_url}images/home1/r6.jpg" alt="r6"></a>
                            </div>
    ...
    <div class="block-section-brand">
        <div class="container">
            <div class="section-brand style1">
                {literal}<div class="owl-carousel nav-style3" data-nav="true" data-autoplay="false" data-dots="false" data-loop="true" data-margin="2" data-responsive='{"0":{"items":1},"480":{"items":2},"600":{"items":4},"1000":{"items":6}}'>{/literal}
                    <a href="" class="item-brand"><img src="{assets_url}images/home1/brand1.jpg" alt="brand1"></a>
                    <a href="" class="item-brand"><img src="{assets_url}images/home1/brand1.jpg" alt="brand1"></a>
                    <a href="" class="item-brand"><img src="{assets_url}images/home1/brand1.jpg" alt="brand1"></a>
                    <a href="" class="item-brand"><img src="{assets_url}images/home1/brand1.jpg" alt="brand1"></a>
                    <a href="" class="item-brand"><img src="{assets_url}images/home1/brand1.jpg" alt="brand1"></a>
