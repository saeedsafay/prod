    ...
    <div class="container relative clearfix">
        <div class="title-holder">
            <div class="title-text">
                <h1 class="uppercase">اطلاعات کاربری</h1>
            </div>
        </div>
    </div>
                                ...
                                <table class="table listtt rtl" dir="rtl">
                                    ...
                                    {foreach from=$CartItems item=Item}
                                        ...
                                        <tr class="cart-subtotal">
                                            ...
                                            <td style="text-align:center"><strong>  {$qty|persian_number}
                                                    ×</strong>
                                            </td>
                                        ...
                                        {assign var=subTotal value=$subTotal+($Item.price * $qty)}
                                    {/foreach}
                                    </tfoot>
                                </table>
                            </div>
...
<section class="htc__product__details ptb-20">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2 class="title_align" style=" padding-bottom: 27px; direction: rtl;
                    ">ورود به حساب</h2>

                {form_open({site_url('users/login')})}
                <div class="single-contact-form">
                    <div class="contact-box">
                        <input name="username" type="text" placeholder="شناسه کاربری یا شماره همراه">
                    </div>
                </div>
                <div class="single-contact-form">
                    <div class="contact-box">
            ...
            <div class="col-md-6" id="register">
                <h2 class="title_align" style=" direction: rtl;">ساخت حساب کاربری</h2>
                <form id="register-form" action="{$register_action}" method="post">
                    ...
                    <div class="single-contact-form">
                        <div class="contact-box">
                            <input type="text" name="username" placeholder="شناسه کاربری*">
                        </div>
                    </div>
                    <div class="single-contact-form">
                        <div class="contact-box">
                    ...
                    <div class="single-contact-form">
                        <p class="rtl">یک رمز عبور برای حساب جدیدتان در سایت وارد کنید. اگر از قبل در سایت عضو هستید، از
                            قسمت ورود به حساب، لاگین کنید</p>
                        <div class="contact-box">
                    ...
                    <div class="contact-btn">
                        <button id="register-form-submit" type="submit" class="btn btn-info">ثبت و ادامه</button>
                    </div>
                </form>
            </div>
        </div>
