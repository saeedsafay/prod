{add_js file="js/dashboard1.js" part="footer"}

<script type="text/javascript">
    var mostVisitedProducts = '{$mostVisitedProducts}';
</script>
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-12 align-self-center">
                <h4 class="text-themecolor">مرکز فروشندگان</h4>
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">سفارشات امروز</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-cyan">{$todayOrders|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    <h3><i class="icon-note"></i></h3>
                                    <p class="text-muted">سفارشات این ماه</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-cyan">{$thisMonthOrders|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar bg-success" role="progressbar"
                                     style="width: 85%; height:6px;" aria-valuenow="{$thisMonthOrders}" aria-valuemin="0"
                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">محصولات ناموجود</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-purple">{$outOfStocks|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar bg-red" role="progressbar" style="width: 85%; height: 6px;"
                                     aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">محصولات در حال اتمام</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-success">{$nearlyOutOfStocks|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="progress">
                                <div class="progress-bar bg-purple" role="progressbar" style="width: 85%; height: 6px;"
                                     aria-valuenow="{$nearlyOutOfStocks}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row page-titles">
            <div class="col-md-12 align-self-center">
                <h4 class="text-themecolor">وضعیت محصولات</h4>
            </div>
        </div>
        <div class="card-group">
            <div class="card">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">فعال</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-cyan">{$activeProducts|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    <h3><i class="icon-note"></i></h3>
                                    <p class="text-muted">بررسی مجدد |‌ غیرفعال</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-cyan">{$inactiveProducts|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    <h3><i class="icon-doc"></i></h3>
                                    <p class="text-muted">تنوع‌های غیرفعال</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-purple">{$inactiveVariants|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    <h3><i class="icon-bag"></i></h3>
                                    <p class="text-muted">تنوع فعال</p>
                                </div>
                                <div class="mr-auto">
                                    <h2 class="counter text-success">{$activeVariants|persian_number}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
...
{*                                                        class="font-medium">Your Mind</span> and you also <br/>laugh at*}
{*                                                the moment</h4>*}
...
{*                    </div>*}
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">نظرات اخیر</h5>
                    </div>
                    <!-- ============================================================== -->
                    <!-- Comment widgets -->
                    <!-- ============================================================== -->
                        ...
                        {foreach $comments as $comment}
                            <div class="d-flex no-block comment-row border-top">
                                ...
                                <div class="comment-text active w-100">
                                    <h5 class="font-medium">{$comment->user->full_name}</h5>
                                    <p class="m-b-10 text-muted">
                                        {$comment.comment}
                                    </p>
                                    <div class="comment-footer">
                                        <span class="text-muted pull-right">
                                            {jdate date=$comment.created_at format="l j F Y - H:i"}
                                        </span>
                                        {if $comment.status}
                                            <span class="badge badge-pill badge-success">تایید شده</span>
                                        {else}

                                            <span class="badge badge-pill badge-warning">تایید نشده</span>
                                        {/if}
                                        <span class="action-icons active">
                                            <a target="_blank"
                                               href="{$comment->commentable->link}">{$comment->commentable->title}</a>
                                    </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body bg-light">
                        <div class="row">
                            ...
                            <div class="col-6 align-self-center display-6 text-left">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6  m-t-30">
                                        ...
                                        <b>(150 Sales)</b></div>
                                    <div class="col-6">
                                        <div id="sparkline2dash" class="text-left"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card bg-purple text-white">
                            <div class="card-body">
                                <h5 class="card-title">۵ محصول پربازدید</h5>
                                <div class="row">
                                    <div class="col-6  m-t-30">
                                    ...
                                    <div class="col-6">
                                        <div id="sales1" class="text-left"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{*                                            <span class="badge badge-pill badge-danger float-left">Today</span>*}
{*                                        </label>*}
{*                                    </div>*}
{*                                    <ul class="assignedto">*}
...
{*                                                    class="badge badge-pill badge-primary float-left">1 week </span>*}
{*                                        </label>*}
{*                                    </div>*}
...
{*                                                    class="badge badge-pill badge-info float-left">Yesterday</span>*}
{*                                        </label>*}
{*                                    </div>*}
{*                                    <ul class="assignedto">*}
{*                                        <li><img src="images/users/3.jpg" alt="user" data-toggle="tooltip"*}
...
{*                                            <span>Lorem Ipsum is simply dummy text of the printing </span> <span*}
{*                                                    class="badge badge-pill badge-warning float-left">2 weeks</span>*}
{*                                        </label>*}
{*                                    </div>*}
{*                                    <div class="item-date"> 26 jun 2017</div>*}
{*                                </li>*}
