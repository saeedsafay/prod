                                                                ...
                                                                <td>
                                                                    ...
                                                                    <p> 
                                                                        {if $val.invoice_type == 1}
                                                                            {$sell} محصول آماده در سایت
                                                                        {else if $val.invoice_type == 2}
                                                                            {$sell} محصول شاخه‌های در سایت
                                                                        {elseif $val.invoice_type == 100}
                                                                            کارمزد معرف
                                                                        {elseif $val.invoice_type == 6}
                                                                            برداشت از حساب کاربری
                                                                        {elseif $val.invoice_type == 10}
                                                                            تسویه حساب فروش
                                                                        {/if}
                                                                    </p>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <p>
                                                                        {if $val.invoice_type == 10}
                                                                            سیستم
                                                                        {else}
                                                                            {$val.user.first_name} {$val.user.last_name} ({$val.user.mobile})
                                                                        {/if}
                                                                    </p>
                                                                </td>
                                                                <td>
